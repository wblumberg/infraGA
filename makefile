...
infraga-2d: prep
	${CC}  ${ATMO_DIR}atmo_io.2d.cpp ${ATMO_DIR}atmo_state.2d.cpp ${UTILS_DIR}fileIO.cpp ${UTILS_DIR}interpolation.cpp ${ATMO_DIR}atmo_state.abs.cart.cpp ${GEOAC_DIR}geoac.params.2d.cpp ${GEOAC_DIR}geoac.eqset.2d.cpp ${UTILS_DIR}rk4solver.cpp ${GEOAC_DIR}geoac.interface.2d.cpp ${UTILS_DIR}waveforms.cpp ${MAINS_DIR}main.infraga.2d.cpp ${CFLAGS} ${LDFLAGS} -o bin/infraga-2d

infraga-3d: prep
	${CC}  ${ATMO_DIR}atmo_io.3d.strat.cpp ${ATMO_DIR}atmo_state.3d.strat.cpp ${UTILS_DIR}fileIO.cpp ${UTILS_DIR}interpolation.cpp ${ATMO_DIR}atmo_state.abs.cart.cpp ${GEOAC_DIR}geoac.params.3d.cpp ${GEOAC_DIR}geoac.eqset.3d.strat.cpp ${GEOAC_DIR}geoac.eigenray.3d.cpp ${UTILS_DIR}rk4solver.cpp ${GEOAC_DIR}geoac.interface.3d.cpp ${UTILS_DIR}waveforms.cpp ${MAINS_DIR}main.infraga.3d.cpp ${CFLAGS} ${LDFLAGS} -o bin/infraga-3d

infraga-3d-rngdep: prep
	${CC}  ${ATMO_DIR}atmo_io.3d.rngdep.cpp ${ATMO_DIR}atmo_state.3d.rngdep.cpp ${UTILS_DIR}fileIO.cpp ${UTILS_DIR}interpolation.cpp ${ATMO_DIR}atmo_state.abs.cart.cpp ${GEOAC_DIR}geoac.params.3d.cpp ${GEOAC_DIR}geoac.eqset.3d.rngdep.cpp ${GEOAC_DIR}geoac.eigenray.3d.cpp ${UTILS_DIR}rk4solver.cpp ${GEOAC_DIR}geoac.interface.3d.cpp ${UTILS_DIR}waveforms.cpp ${MAINS_DIR}main.infraga.3d.rngdep.cpp ${CFLAGS} ${LDFLAGS} -o bin/infraga-3d-rngdep

infraga-sph: prep
	${CC}  ${ATMO_DIR}atmo_io.sph.strat.cpp ${ATMO_DIR}atmo_state.sph.strat.cpp ${UTILS_DIR}globe.cpp ${UTILS_DIR}fileIO.cpp ${UTILS_DIR}interpolation.cpp ${ATMO_DIR}atmo_state.abs.sph.cpp ${GEOAC_DIR}geoac.params.sph.cpp ${GEOAC_DIR}geoac.eigenray.sph.cpp ${GEOAC_DIR}geoac.eqset.sph.strat.cpp ${UTILS_DIR}rk4solver.cpp ${GEOAC_DIR}geoac.interface.sph.cpp ${UTILS_DIR}waveforms.cpp ${MAINS_DIR}main.infraga.sph.cpp ${CFLAGS} ${LDFLAGS} -o bin/infraga-sph

infraga-sph-rngdep: prep
	${CC}  ${ATMO_DIR}atmo_io.sph.rngdep.cpp ${ATMO_DIR}atmo_state.sph.rngdep.cpp ${UTILS_DIR}globe.cpp ${UTILS_DIR}fileIO.cpp ${UTILS_DIR}interpolation.cpp ${ATMO_DIR}atmo_state.abs.sph.cpp ${GEOAC_DIR}geoac.params.sph.cpp ${GEOAC_DIR}geoac.eigenray.sph.cpp ${GEOAC_DIR}geoac.eqset.sph.rngdep.cpp ${UTILS_DIR}rk4solver.cpp ${GEOAC_DIR}geoac.interface.sph.cpp ${UTILS_DIR}waveforms.cpp ${MAINS_DIR}main.infraga.sph.rngdep.cpp ${CFLAGS} ${LDFLAGS} -o bin/infraga-sph-rngdep
